...
import ca.gc.hc.siteDemo.util.JsonBuilder;
 ...
 */
public class ActionUtil		// TODO rename it
{
    ...
    throws RemoteException
  {
    ...
    if (bean.getVetSpecies().size()== 0)
    	bean.setVetSpecies(null);

    if (bean.getPharmMonitorActs().size() == 0)
		bean.setPharmMonitorActs(null);

    if (bean.getRiskMinMeasures().size() == 0)
		bean.setRiskMinMeasures(null);
...
//	}
	...
	// TODO move it to controller or service??
...
//	}
	 ...
	 *            AjaxBean
	 *            </p>
	 * @author Sylvain Larivière 2016-08-12
	 */
...
//	}
	...
	// TODO remove it??
//    public static Locale setRequestLocale(HttpServletRequest request) {
